...
export default function DashboardPage() {
  ...
  const actions = [
    ...
    { to: '/admin/customers', title: 'Customer Registration', desc: 'Register shippers for account billing and loyalty', icon: 'bi-people', color: 'danger', show: can(caps, 'consignments') },
    ...
    { to: '/admin/areas', title: 'Areas', desc: 'Last-mile territories under a delivery point', icon: 'bi-pin-map', color: 'danger', show: can(caps, 'routing') },
    ...
    { to: '/admin/dispatchers', title: 'Dispatcher Management', desc: 'Assigned to a last-mile area', icon: 'bi-headset', color: 'danger', show: can(caps, 'staff') },
