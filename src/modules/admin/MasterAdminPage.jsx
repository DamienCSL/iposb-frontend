...
export const MASTER_CATEGORIES = [
  ...
  },
  {
    ...
    icon: <TeamOutlined />,
    description: 'Corporate shipper accounts and back-office staff credentials.',
    resources: [
...
export const MASTER_SCHEMAS = {
  ...
  customers: {
    ...
    fields: [
      ...
      { name: 'branch_code', label: 'Branch Code', lookup: 'branches' },
      {
        name: 'invoice_pricing_scheme',
        label: 'Default invoice pricing scheme',
        type: 'select',
        options: [
          { label: 'Walk-in / single shipment', value: 'walk_in' },
          { label: 'Contract detail by rate band', value: 'contract_bands' },
        ],
      },
      { name: 'invoice_attn', label: 'Invoice Attn' },
      {
        name: 'invoice_terms',
        label: 'Invoice terms',
        type: 'select',
      ...
      },
      {
        ...
        label: 'Preferred invoice components (JSON or comma codes)',
        type: 'textarea',
        placeholder: '["line_cn","line_date","tax_sst"]',
      },
      { name: 'invoice_our_ref_prefix', label: 'Our Ref prefix' },
    ],
    pk: 'id',
  },
  users: {
